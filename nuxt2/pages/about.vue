    ...
    <b-container>
      ...
      <b-row>
        <b-col>
          ...
          <p>
            Кроме того, сервис предоставляет информацию о прошлых землетрясениях, позволяя пользователям изучить историю сейсмической активности на интерактивной карте
          </p>
        </b-col>
      </b-row>
      <b-row>
